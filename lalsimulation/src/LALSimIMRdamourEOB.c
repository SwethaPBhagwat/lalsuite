...
static
REAL8 XLALpphiInitP4PN( const REAL8 r, const REAL8 eta );

static
REAL8 XLALrOfOmegaP4PN( REAL8 r, void *params);

static
REAL8 XLALvrP4PN(const REAL8 r, const REAL8 omega, const REAL8 eta);
...
REAL8
XLALpphiInitP4PN(
            const REAL8 r, const REAL8 eta )                  /**<< Initial orbital separation *)**/
{
  REAL8 u, u2, A, dA;
            ...
            )
{
  ...
  omega1 = pr3in->omega;
  omega2 = omegaofrP4PN(r, pr3in->eta);
